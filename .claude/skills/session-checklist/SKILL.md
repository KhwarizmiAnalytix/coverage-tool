...
description: Verify non-trivial changes in coverage-tool before handoff or commit, including supported build systems, tests, configured lint, and diff review.
---
